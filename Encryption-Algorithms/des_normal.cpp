...
#include<string.h>
using namespace std;
int bina[70],index=0,binary[64],round=1,round1=16;
int p[64];
int xor2[60],xor1[40];
...
void hex(int per[67])
{
    ...
    for(i=0;i<64;i=i+4)
    {
        ...
        if(per[i+j]==0)
            ...
            if(strcmp(ch,"0000")==0)
                cout<<"0";
            else if(strcmp(ch,"0001")==0)
                cout<<"1";
                else if(strcmp(ch,"0010")==0)
                cout<<"2";
                else if(strcmp(ch,"0011")==0)
                cout<<"3";
                else if(strcmp(ch,"0100")==0)
                cout<<"4";
                else if(strcmp(ch,"0101")==0)
                cout<<"5";
                else if(strcmp(ch,"0110")==0)
                cout<<"6";
                else if(strcmp(ch,"0111")==0)
                cout<<"7";
                else if(strcmp(ch,"1000")==0)
                cout<<"8";
                else if(strcmp(ch,"1001")==0)
                cout<<"9";
                else if(strcmp(ch,"1010")==0)
                cout<<"a";
                else if(strcmp(ch,"1011")==0)
                cout<<"b";
                else if(strcmp(ch,"1100")==0)
                cout<<"c";
                else if(strcmp(ch,"1101")==0)
                cout<<"d";
                else if(strcmp(ch,"1110")==0)
                cout<<"e";
                else if(strcmp(ch,"1111")==0)
                cout<<"f";
    }
}
void xorop()
...
if(round==1)
    key_generation();
cout<<"\n Generated key for round "<<round<<":\n";

        for(j=0;j<48;++j)
            roun[j]=rou[round-1][j];
        for(j=0;j<48;++j)
        cout<<roun[j];
            xorop();
            s_index=0;
